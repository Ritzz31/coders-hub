							...
							<div class="col-xs-12">
								...
								<form class="cmxform form-horizontal " id="commentForm" method="get" action="" novalidate="novalidate">
									...
									<div class="form-group">
										...
										<div class="col-lg-6">
											<textarea class="form-control" id="ccomment" name="ccomment" required="">
									...
									<div class="form-group ">
                                        <label for="cname" class="col-sm-3 control-label no-padding-right">Degree:</label>
                                    ...
                                    <div class="form-group ">
                                        <label for="cname" class="col-sm-3 control-label no-padding-right">Gender:</label>
                                        <div class="col-xs-10 col-sm-5">
                                    ...
                                    <div class="form-group ">
                                        <label for="cname" class="col-sm-3 control-label no-padding-right">City</label>
                                        <div class="col-lg-6">
