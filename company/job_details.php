...
<html lang="en">
	<head>
		...
		<![endif]-->
		<link rel="styl esheet" href="assets/css/ace-skins.min.css" />
						...
						<div class="row">
							...
							<form method="post">
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
									<h2 align="center" ><u>View Jobs Details</u></h2>
									<tr>
										<td>Job_id:</td>
									...
									<tr>
										<td colspan="2" align="center">
											 <a href="job_delete.php?delid=<?php echo $row->Job_id;?>" class="btn btn-danger">Delete</a>
                          <a href="job_edit.php?editid=<?php echo $row->Job_id;?>" class="btn btn-success">Edit</a>
										</td>
									</tr>
