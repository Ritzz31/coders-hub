...
$aid = $_GET["aid"];
$result=$obj->query("SELECT table_answer.*, user.Fname,user.Lname,user.Email,user.Contact, table_query.Subject FROM table_answer INNER JOIN user ON table_answer.User_id=user.User_id INNER JOIN table_query ON table_answer.Query_id = table_query.Id WHERE table_answer.Id='$aid' ");
